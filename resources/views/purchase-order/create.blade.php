...
<form method="POST" action="{{route('purchase-order.store')}}" id="purchase_form">
    @csrf
<div class="row">
    ...
    <div class="card mb-3">
        <div class="card-header my-flex">
            <div>
                ...
                <p style="position: absolute;" class="mt-2">Balance ksh: <span id="balan">{{number_format($rightsAmt, 2)}}</span></p>
            </div>
