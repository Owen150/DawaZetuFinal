<form action="{{ route('store_role') }}" method="POST">
    ...
    <div>
      <button type="submit" class="btn btn-success ms-3">Submit <span style="position: relative; top:2px; left: 2px" ><ion-icon name="checkbox-outline"></ion-icon></span></button>
    </div>
</form>