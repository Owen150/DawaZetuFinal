...
<nav class="mynav page-breadcrumb">
  ...
  <div class="cancel">
    <div></div>
    <a href="{{route('roles.index')}}"><button class="btn btn-warning"><span><ion-icon style="position: relative; top:2px; right: 3px" name="arrow-back-outline"></ion-icon></span> Go Back</button></a>
  </div>
</nav>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="role_name" class="form-control mt-2" placeholder="Role Name" required>
          </div>
