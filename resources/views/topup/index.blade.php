...
<div class="row mb-3">
    <div class="col-sm-9">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('topup.index') }}">Top Ups</a></li>
            ...
            <nav class="m-2">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                        type="button" role="tab" aria-controls="nav-home" aria-selected="true">CREATE REQUEST</button>
                                            ...
                                            <div class="row">
                                                <div class="d-flex">
                                                    <div style="padding-right:5px;">
                                                        <a href="{{ url('topup/' .$topup->id . '/edit') }}"
                                                    ...
                                                    <div style="padding-right:5px;">
                                                        <a href="{{ url('topup/' .$topup->id ) }}"
                                                            class="btn btn-sm btn-warning mr-3">
                                                            View Details
                                                        </a>
                                                    </div>
                                                    <form action="{{ url('topup/'.$topup->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="d-flex">
                                                    ...
                                                    <div style="padding-right:5px;">
                                                        <a href="{{ url('processedtopups/' .$topup->id ) }}"
                                                            class="btn btn-sm btn-warning mr-3">
                                                            View Details
                                                        </a>
                                                    </div>
