            ...
            <div class="card-header">
                <div class="row">
                    <div class="d-flex">
                        ...
                        <div class="col-sm-2">
                            <a href="{{ route('topup.index') }}" class="btn btn-md btn-danger">Cancel <span><i
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" placeholder="Enter Name" id="requested_by" name="requested_by">
                            </div>
                        </div><!-- Col -->
                        <div class="col-sm-4">
                            <div class="mb-3">
                                <label class="form-label" for="request_date">Date</label>
                                <input required type="date" class="form-control" name="request_date" placeholder="Enter Date">
                            </div>
                        </div><!-- Col -->
