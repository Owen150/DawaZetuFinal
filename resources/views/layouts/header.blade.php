      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          ...
          <ul class="list-unstyled p-1" >
            <li class="dropdown-item py-2 {{ active_class(['profile']) }}">
              <a href="{{ route('index_profile', Auth::user()->id) }}" class="text-body ms-0">
                <i class="me-2 icon-md" data-feather="user"></i>
                <span>Profile</span>
              </a>
            </li>
            <li class="dropdown-item py-2 {{ active_class(['profile']) }}">
              <a href="{{ route('profile.edit', Auth::user()->id)  }}" class="text-body ms-0">
